...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,6],$V1=[1,8],$V2=[1,9],$V3=[1,10],$V4=[1,14],$V5=[8,19,22],$V6=[1,44],$V7=[1,43],$V8=[1,42],$V9=[1,45],$Va=[1,46],$Vb=[11,23,48,49,50],$Vc=[1,52],$Vd=[8,19,22,44],$Ve=[8,12,19,22,44,47],$Vf=[8,22],$Vg=[8,12,22];
var parser = {trace: function trace () { },
yy: {},
symbols_: {"error":2,"expressions":3,"fromExpr":4,"WHERE":5,"boolExpr":6,"orderLimit":7,"EOF":8,"FROM":9,"fromVals":10,"STRING":11,",":12,"fromType":13,"DOC":14,"COLLECTION":15,"COLGROUP":16,"compExpr":17,"boolOp":18,"ORDER":19,"BY":20,"orderExpr":21,"LIMIT":22,"INT":23,"orderItem":24,"IDENTIFIER":25,"orderType":26,"ASC":27,"DESC":28,"name":29,"compOp":30,"literal":31,"arrayOp":32,"array":33,"<":34,"<=":35,"==":36,">=":37,">":38,"!=":39,"array-contains":40,"array-contains-any":41,"in":42,"not-in":43,"and":44,"[":45,"arrayItems":46,"]":47,"FLOAT":48,"BOOL":49,"VAR":50,"$accept":0,"$end":1},
terminals_: {2:"error",5:"WHERE",8:"EOF",9:"FROM",11:"STRING",12:",",14:"DOC",15:"COLLECTION",16:"COLGROUP",19:"ORDER",20:"BY",22:"LIMIT",23:"INT",25:"IDENTIFIER",27:"ASC",28:"DESC",34:"<",35:"<=",36:"==",37:">=",38:">",39:"!=",40:"array-contains",41:"array-contains-any",42:"in",43:"not-in",44:"and",45:"[",47:"]",48:"FLOAT",49:"BOOL",50:"VAR"},
productions_: [0,[3,5],[3,4],[4,2],[10,3],[10,4],[10,1],[10,2],[13,1],[13,1],[13,1],[6,3],[6,1],[7,5],[7,3],[7,2],[21,3],[21,1],[24,2],[24,1],[26,1],[26,1],[17,3],[17,3],[30,1],[30,1],[30,1],[30,1],[30,1],[30,1],[32,1],[32,1],[32,1],[32,1],[18,1],[33,3],[33,2],[46,3],[46,1],[31,1],[31,1],[31,1],[31,1],[31,1],[29,1]],
...
switch (yystate) {
case 1:
return {from: $$[$0-4], where: $$[$0-2], order: $$[$0-1].order, limit: $$[$0-1].limit};
break;
case 2:
return {from: $$[$0-3], where: $$[$0-1], order: [], limit: null};
break;
case 3:
this.$ = $$[$0]
break;
...
break;
case 43:
this.$ = {type: 'var', v: yytext.slice(2, -1)};
break;
case 44:
...
defaultActions: {5:[2,3],8:[2,8],9:[2,9],10:[2,10],18:[2,2],22:[2,34],31:[2,30],32:[2,31],33:[2,32],34:[2,33],35:[2,4],37:[2,1],39:[2,15],49:[2,5],63:[2,13],65:[2,37]},
...
rules: [/^(?:\s+)/,/^(?:[0-9]+\.[0-9]+\b)/,/^(?:[0-9]+\b)/,/^(?:(true|false))/,/^(?:and\b)/,/^(?:"(\\["]|[^"])*")/,/^(?:\$\{[a-zA-Z0-9 ][a-zA-Z0-9_ ]*\})/,/^(?:FROM\b)/,/^(?:WHERE\b)/,/^(?:DOC\b)/,/^(?:COLLECTION\b)/,/^(?:COLGROUP\b)/,/^(?:ORDER\b)/,/^(?:BY\b)/,/^(?:LIMIT\b)/,/^(?:ASC\b)/,/^(?:DESC\b)/,/^(?:\[)/,/^(?:\])/,/^(?:,)/,/^(?:<=)/,/^(?:<)/,/^(?:==)/,/^(?:>=)/,/^(?:>)/,/^(?:!=)/,/^(?:array-contains-any\b)/,/^(?:array-contains\b)/,/^(?:in\b)/,/^(?:not-in\b)/,/^(?:[a-zA-Z]{1,}[a-zA-Z0-9_]*)/,/^(?:$)/,/^(?:.)/],
